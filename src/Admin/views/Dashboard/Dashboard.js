...
//import Tasks from "Admin/components/Tasks/Tasks.js";
...
//import { bugs, website, server } from "Admin/variables/general";
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="warning" stats icon>
              ...
              <p className={classes.cardCategory}>Total Spend</p>
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="danger" stats icon>
              ...
              <p className={classes.cardCategory}>Total Garbage</p>
